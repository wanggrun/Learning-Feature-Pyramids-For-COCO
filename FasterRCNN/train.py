...
class Model(ModelDesc):
    ...
    def build_graph(self, *inputs):
        ...
        _, featuremap = pretrained_resnet_conv4(image, config.RESNET_NUM_BLOCK[:3])
        ...
        def ff_true():
            _, feature_fastrcnn = resnet_conv5(roi_resized, config.RESNET_NUM_BLOCK[-1])    # nxcx7x7
        ...
        if is_training:
            ...
            if config.MODE_MASK:
                ...
                def f1():
                    ...
                    _, feature_maskrcnn = resnet_conv5(roi_resized, config.RESNET_NUM_BLOCK[-1])
